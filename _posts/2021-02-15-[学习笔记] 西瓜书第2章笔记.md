...
\begin{equation}
\text { cost }_{\text {norm }}=\frac{\mathrm{FNR} \times p \times cost_{01}+\mathrm{FPR} \times(1-p) \times cost_{10}}{p \times cost_{01}+(1-p) \times cost_{10}}
\end{equation}
